...
class EEGWave(nn.Module):
    def __init__(
        ...
        # (batch_size, 1, eeg_channels, eeg_length)
        self.x_conv = nn.Sequential(
            nn.Conv2d(inp_channels, res_channels, (eeg_channels, 1)),
            nn.ReLU(),
        )
        # (batch_size,res_channel, 1, eeg_length)
    ...
    def _create_nn_embedding_layer(self, condition):
        ...
        """
        print(self.conditionals_combinations[condition].nunique())
